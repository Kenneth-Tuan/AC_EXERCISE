...
function getMoviesByPage(page) {
  ...
  currentList = data.slice(startIndex, startIndex + MOVIES_PER_PAGE)
...
paginator.addEventListener('click', function onPaginatorClicked(event) {
  ...
  currentPage = getMoviesByPage(page)
  renderMovieList(currentList)
})

// switch cardmode & listmode
switchBtn.addEventListener('click', function onSwitchBtnClicked(event) {
...
axios
  ...
  .then((response) => {
    ...
    currentPage = renderMovieList(getMoviesByPage(1))
  })
